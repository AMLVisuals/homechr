...
export default function PrestataireError({
  ...
  useEffect(() => {
    console.error('[CHR Connect] Erreur espace prestataire:', error);
  }, [error]);
    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-[var(--bg-main)]">
      ...
      >
        ...
        <h1 className="mb-2 text-xl font-semibold text-[var(--text-primary)]">
          Erreur - Espace Prestataire
        </h1>

        <p className="mb-8 text-sm text-[var(--text-secondary)]">
          Une erreur est survenue dans votre espace prestataire.
        </p>
        ...
        <div className="flex flex-col gap-3">
          ...
          <Link
            href="/prestataire/tableau-de-bord"
