...
import { Search, Phone, MessageSquare, UserPlus, Trash2, Users, CalendarDays } from 'lucide-react';
...
import TeamPlanning from '../team/TeamPlanning';
    ...
    <div className="h-full flex flex-col relative overflow-hidden">
      <div className="flex-1 overflow-y-auto custom-scrollbar relative">
        ...
        <div className="sticky top-0 z-0 md:static md:z-auto pb-4">
          <div className="flex flex-col md:flex-row justify-between items-center md:items-center gap-4 md:gap-4 mb-4 md:mb-8 p-4 md:p-0">
            <div className="text-center md:text-left w-full md:w-auto">
              ...
              <p className="text-sm md:text-base text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-blue-400 font-medium animate-pulse">Gérez votre équipe et leur planning</p>
            </div>
        ...
        <div className="relative z-10 bg-[var(--bg-card)] rounded-t-3xl border-t border-[var(--border)] shadow-lg min-h-full md:z-auto md:bg-transparent md:rounded-none md:border-none md:shadow-none">
          ...
          {view === 'planning' ? (
            <div className="px-4 md:px-0 py-4 pb-20">
              <TeamPlanning />
            </div>
          ) : (
            <>
