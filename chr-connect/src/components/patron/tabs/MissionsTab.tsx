    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center md:items-center gap-6 md:gap-4 mb-8">
        <div className="text-center md:text-left w-full md:w-auto">
          <h2 className="text-3xl font-bold mb-1 bg-gradient-to-r from-white via-blue-100 to-white bg-clip-text text-transparent">Missions</h2>
        ...
        <div className="flex items-center gap-2 bg-[#1a1a1a] p-1 rounded-xl border border-white/10 w-full md:w-auto">
          <div className="relative flex-1">
            ...
            <input 
              ...
              className="bg-transparent border-none focus:ring-0 focus:outline-none text-sm text-white pl-9 w-full md:w-64 placeholder:text-gray-600"
            />
          </div>
        ...
        <div className="grid grid-cols-1 gap-4">
          {filteredMissions.map((mission) => (
            <motion.div
              ...
              className="bg-[#1a1a1a] rounded-xl p-4 md:p-6 border border-white/5 hover:border-white/20 transition-all cursor-pointer group relative overflow-hidden"
            >
              {/* Status Stripe */}
              <div className={clsx(
              ...
              <div className="flex flex-col md:flex-row justify-between items-start mb-3 md:mb-4 pl-3 md:pl-4 gap-3 md:gap-0">
                <div className="flex items-center gap-3 md:gap-4 w-full md:w-auto">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="font-bold text-base md:text-lg text-white group-hover:text-blue-400 transition-colors truncate">{mission.title}</h3>
                    <div className="flex items-center gap-2 text-xs md:text-sm text-gray-400">
                      <span className="font-medium text-gray-300 truncate">{mission.category}</span>
                ...
                <div className="flex flex-row md:flex-col items-center md:items-end justify-between w-full md:w-auto mt-1 md:mt-0">
                  <p className="font-bold text-white text-base md:text-lg order-2 md:order-1">{mission.price}</p>
                  <span className={clsx(
              ...
              <div className="flex items-center gap-4 md:gap-6 pl-3 md:pl-4 text-xs md:text-sm text-gray-500">
                ...
                {mission.expert && mission.expert !== 'En attente' && (
                  <div className="flex items-center gap-1.5 shrink-0">
                    <div className="w-4 h-4 md:w-5 md:h-5 rounded-full bg-gray-700 flex items-center justify-center text-[10px] md:text-xs text-white font-bold">
