...
export default function VenueForm({ initialData, onClose, onSuccess }: VenueFormProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-[#1a1a1a] text-white">
      <div className="flex items-center justify-between p-6 border-b border-white/10 bg-[#1a1a1a] z-10 sticky top-0">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar">
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium text-gray-400 ml-1">Photos du lieu</label>
          <VenuePhotoUploader 
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
          ...
          >
            ...
            {sections.general ? <Eye className="w-4 h-4 text-gray-400" /> : <EyeOff className="w-4 h-4 text-gray-400" />}
          </button>
          
          {sections.general && (
            <div className="p-4 border-t border-white/10 space-y-4 animate-in fade-in slide-in-from-top-2">
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-black/20 border border-white/10 rounded-xl p-3 focus:ring-1 focus:ring-blue-500"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-black/20 border border-white/10 rounded-xl p-3 focus:ring-1 focus:ring-blue-500 appearance-none"
                  >
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-500 mb-1">Effectif (nombre)</label>
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full bg-black/20 border border-white/10 rounded-xl p-3 pl-10 focus:ring-1 focus:ring-blue-500"
                      placeholder="0"
                    />
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-500 mb-1">Capacité (pers.)</label>
                  <div className="relative">
                    <Users className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500" />
                    <input 
                      type="number" 
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
          ...
          >
            ...
            {sections.access ? <Eye className="w-4 h-4 text-gray-400" /> : <EyeOff className="w-4 h-4 text-gray-400" />}
          </button>
          ...
          {sections.access && (
            <div className="p-4 border-t border-white/10 space-y-4 animate-in fade-in slide-in-from-top-2">
               ...
               <div>
                  <label className="block text-xs font-medium text-gray-500 mb-1">Instructions d'accès</label>
                  <textarea 
                    value={formData.access?.instructions || ''}
                    onChange={e => setFormData({...formData, access: {...formData.access, instructions: e.target.value}})}
                    className="w-full bg-black/20 border border-white/10 rounded-lg p-2 text-sm min-h-[80px]"
               ...
               <div className="grid grid-cols-2 gap-4 pt-2 border-t border-white/5">
                 <div>
                    <label className="block text-xs font-medium text-gray-500 mb-1">WiFi SSID</label>
                    <input 
                      type="text" 
                 ...
                 <div>
                    <label className="block text-xs font-medium text-gray-500 mb-1">WiFi Password</label>
                    <input 
                      type="text" 
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
          ...
          >
            ...
            {sections.technical ? <Eye className="w-4 h-4 text-gray-400" /> : <EyeOff className="w-4 h-4 text-gray-400" />}
          </button>
          ...
          {sections.technical && (
            <div className="p-4 border-t border-white/10 space-y-4 animate-in fade-in slide-in-from-top-2">
               <div className="grid grid-cols-2 gap-4">
                 <div>
                    <label className="block text-xs font-medium text-gray-500 mb-1">Type Électrique</label>
                    <select 
                 ...
                 <div>
                    <label className="block text-xs font-medium text-gray-500 mb-1">Type Gaz</label>
                    <select 
               ...
               <div className="grid grid-cols-2 gap-4">
                 <div>
                    <label className="block text-xs font-medium text-gray-500 mb-1">Accès Livraison</label>
                    <select 
                 ...
                 <div className="flex items-center gap-4 pt-6">
                   <label className="flex items-center gap-2 text-sm text-gray-300 cursor-pointer">
                     <input 
                       ...
                       className="rounded border-white/10 bg-black/20 text-blue-500"
                     />
                     Monte-charge
                   </label>
                 </div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
          ...
          >
            ...
            {sections.equipment ? <Eye className="w-4 h-4 text-gray-400" /> : <EyeOff className="w-4 h-4 text-gray-400" />}
          </button>
          
          {sections.equipment && (
            <div className="p-4 border-t border-white/10 space-y-4 animate-in fade-in slide-in-from-top-2">
              <div>
                <label className="block text-xs font-medium text-gray-500 mb-1">Système de Caisse (POS)</label>
                <input 
                  type="text" 
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
          ...
          >
            ...
            {sections.hours ? <Eye className="w-4 h-4 text-gray-400" /> : <EyeOff className="w-4 h-4 text-gray-400" />}
          </button>
          
          {sections.hours && (
            <div className="p-4 border-t border-white/10 space-y-2 animate-in fade-in slide-in-from-top-2">
              {Object.entries(formData.openingHours || {}).map(([day, hours]) => {
                ...
                return (
                  <div key={day} className="flex items-center justify-between py-2 border-b border-white/5 last:border-0">
                    <div className="w-24 font-medium text-gray-300">{dayLabels[day]}</div>
                    <div className="flex items-center gap-4">
                      <label className="flex items-center gap-2 text-xs text-gray-500 cursor-pointer">
                        <input 
                          ...
                          className="rounded border-white/10 bg-black/20 text-red-500"
                        />
                        Fermé
                      </label>
      ...
      <div className="p-6 border-t border-white/10 flex gap-4 bg-black/20 shrink-0 z-10">
        <button 
          onClick={onClose}
